<script>
  ...
  $: if (portfolioData && portfolioData.length > 0) {
    ...
    const nonFeatured = portfolioData.filter((p) => !p.featured);
    const sortedProjects = [...featured, ...nonFeatured];

    if (showAll) {
      displayedProjects = sortedProjects;
    } else {
      displayedProjects = sortedProjects.slice(0, 3);
    }
  }
...
<!-- Projects Section -->
<section id="projects" class="py-16 dark:bg-primary">
  <div class="container mx-auto px-6">
    <!-- Section Header -->
    <div class="text-center mb-16">
      <h2
        class="text-3xl md:text-4xl font-bold text-gray-900 mb-4 dark:text-white"
      >
    ...
    <div class="max-w-6xl mx-auto space-y-16">
      {#each displayedProjects as project, index (project.id || index)}
        <div
        ...
        >
          <div class="bg-transperent">
            ...
            >
              <!-- Image Container -->
              <div
                class="lg:w-1/2 relative overflow-hidden flex items-center justify-center"
              >
                <img
                  src={project.image}
                ...
                <!-- Overlay Gradient -->
                <div
                  class="absolute inset-0 bg-gradient-to-t from-black/20 to-transparent lg:hidden"
                ></div>
              </div>
              ...
              <div class="lg:w-1/2 p-8 lg:p-12 flex flex-col justify-center">
                ...
                <!-- Title -->
                <h3
                  class="text-xl lg:text-2xl font-bold text-gray-900 mb-4 leading-tight dark:text-white"
                >
                ...
                <div class="mb-8">
                  ...
                  <div class="flex flex-wrap gap-2">
                    {#each project.tech as tech}
                      <span
                        class="bg-white text-primary border-1 border-primary
                               text-sm px-3 py-1
                ...
                <div class="flex flex-col sm:flex-row gap-4">
                  <a
                    ...
                    class="inline-flex items-center justify-center px-4 py-2
                           ...
                           hover:shadow-lg group/btn dark:border-1"
                    target="_blank"
                  >
                    <svg
                      class="w-5 h-5 mr-2"
                  ...
                  {#if project.demo}
                    <a
                      ...
                      class="inline-flex items-center justify-center px-4 py-2
                             ...
                             border-1 border-blue-600 hover:bg-blue-600 hover:text-white
                  ...
                  <!-- Read More button — navigate to full project detail page -->
                  <a
                  ...
                  >
                    <svg
                      class="w-5 h-5 mr-2 group-hover/btn:translate-x-0.5 transition-transform"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
                    ...
                    <span class="group-hover/btn:translate-x-0.5 transition-transform">
                      {uiStrings[currentLang].readMore}
                    </span>
                  </a>
                </div>
              </div>
    ...
    {#if portfolioData.length > 3}
      <div class="mt-16 text-center">
        <button
          ...
          class="inline-flex items-center px-8 py-3 border-2 border-blue-600 text-blue-600 font-medium bg-transparent hover:bg-blue-600 hover:text-white transition-all duration-300 dark:border-white dark:text-white dark:hover:bg-white dark:hover:text-primary"
        >
          {showAll
            ? uiStrings[currentLang].viewLessProjects
            : uiStrings[currentLang].viewMoreProjects}
        </button>
      </div>
    {/if}
  </div>
